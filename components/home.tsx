    ...
    return (
        ...
        <div className="min-h-[calc(100vh-6rem)] flex flex-col justify-center">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-8">
                <BlurFade delay={BLUR_DELAY}>
                    <img
                        src={DATA.personalData.image} // Make sure `image` exists in your data
                        alt={`${DATA.personalData.name}'s profile`}
                        className="w-32 h-32 md:w-fit md:h-fit rounded-full object-cover shadow-lg"
                    />
                </BlurFade>
